...
//         out.println("<!--content-->");
            ...
            out.println("<a href=\"customerAdd\">");
            out.println("<h3>Add Customer<h3>");
            out.println("</a>");
            out.println("<table>");
            out.println("<tr><th> Customer name</th><th>Address</th><th> Mobile no</th><th>Email Id</th><th>UserName</th><th>Password</th></tr>");
            customerDAO rd = new customerDAO();
            ArrayList<customerBean> list = rd.findAll();
            for (customerBean bean : list) {
                ...
                out.println("<td>" + bean.getPassword() + "</td>");
                System.out.println(bean.getCustomerid());
                out.println("<td><a href=\"/customerUpdate?customerid=" + bean.getCustomerid() + "\">Edit</a></td>");
                out.println("<td><a href=\"/customerListforAdmin?opn=delete&customerid=" + bean.getCustomerid() + "\">Delete</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
//         out.println("<!--content-->");
