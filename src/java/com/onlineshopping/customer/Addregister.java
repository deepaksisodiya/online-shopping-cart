...
out.println("<title>Deepak sisodiya</title>");
...
out.println("<div id=\"templatemo_wrapper\">");
	out.println("<div id=\"templatemo_menu\">");
         ...
         dispatcher = request.getRequestDispatcher("/design/menuforHome.html");
...
out.println("<form method=\"post\" action=\"customerList?opn=add\"  onSubmit=\"return validate(this);\">");
out.println("<table>");
out.println("<tr><td><b> Name: </b></td><td> <input type=text name=customername></td></tr><br><br>");
out.println("<tr><td><b> Address: </b></td><td> <input type=text name=address></td></tr><br><br>");
out.println("<tr><td><b> Mobile no:</td><td> </b> <input type=text name=phone></td></tr><br><br>");
out.println("<tr><td><b> Email Id:</td><td> </b> <input type=text name=email></td></tr><br><br>");
out.println("<tr><td><b> Username: </b></td><td> <input type=text name=username></td></tr><br><br>");
out.println("<tr><td><b> Password: </b></td><td> <input type=password name=password></td></tr><br>");
out.println("<tr><td><input type=submit name=Submit></td>");
out.println("<td><input type=reset name=Clear content></td></tr>");
