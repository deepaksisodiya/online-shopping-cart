 ...
 * @author deepak
 */
public class aboutdeepak extends HttpServlet {
...
//        out.println("<!--member-->");
          ...
          dispatcher = request.getRequestDispatcher("/design/deepak.html");
          dispatcher.include(request, response);
//
...
//    out.println("<div id=\"templatmeo_content\">");
         ...
         dispatcher = request.getRequestDispatcher("/design/deepak2.html");
         dispatcher.include(request, response);
//
...
//
          out.println("<!--content-->");
//        dispatcher = request.getRequestDispatcher("/design/aboutdeepak.html");
//        dispatcher.include(request, response);
