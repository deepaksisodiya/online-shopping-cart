...
package com.onlineshopping.home;
...
//          out.println("<div id=\"sidebar1\"><div class=\"sidebar_top1\"></div><div class=\"sidebar_bottom1\"></div>");
//
          out.println("<!--content-->");

          out.println("<font color=white><h1>Hello!</h1></font><br>");
          out.println("<font color=white><h1>Online Shopping site is developed by Deepak sisdoiya as a Minor project to submit in college Technocrats Institute of Technology Bhopal M.P.</h1></font>");
