...
//         out.println("<!--content-->");
            ...
            out.println("<a href=\"productAdd\">");
            out.println("<h3>Add Product<h3>");
            out.println("</a>");
            out.println("<table>");
            out.println("<tr><th> CategoryID</th><th> ProductName</th><th> ProductPrice</th><th> Stockinhand</th><th> dangerLevel</th></tr>");
            productDAO rd = new productDAO();
            ArrayList<productBean> list = rd.findAll();
            for (productBean bean : list) {
                out.println("<tr>");
                out.println("<td>" + bean.getCategoryid() + "</td>");
                out.println("<td>" + bean.getProductname() + "</td>");
                out.println("<td>" + bean.getProductprice() + "</td>");
                out.println("<td>" + bean.getStockinhand() + "</td>");
                out.println("<td>" + bean.getDangerlevel() + "</td>");
                System.out.println(bean.getProductid());
                out.println("<td><a href=\"productUpdate?productid=" + bean.getProductid() + "\">Edit</a></td>");
                out.println("<td><a href=\"/productList?opn=delete&productid=" + bean.getProductid() + "\">Delete</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
//         out.println("<!--content-->");
