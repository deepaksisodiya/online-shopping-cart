...
out.println("<script language=\"javascript\" type=\"text/javascript\">");
 RequestDispatcher dispatcher1 = request.getRequestDispatcher("/scripts/validate.js");
...
//
        ...
        out.println("<form method=\"post\" action=\"productList?opn=update\" onSubmit=\"return validate(this);\">");
            int id = Integer.parseInt(request.getParameter("productid"));
            productDAO cd = new productDAO();
            productBean bean = cd.find(id);
            out.println("<input type=\"hidden\" name=\"productid\" value="+bean.getProductid()+">");
            out.println("<b>Category ID : </b> <input type=\"text\" name=\"categoryid\" value="+bean.getCategoryid()+"> <br/>");
            out.println("<b>Product Name : </b> <input type=\"text\" name=\"productname\" value="+bean.getProductname()+"><br/> ");
            out.println("<b>Product Price : </b> <input type=\"text\" name=\"productprice\" value="+bean.getProductprice()+"><br/> ");
            out.println("<b>Stock Inhand : </b> <input type=\"text\" name=\"stockinhand\" value="+bean.getStockinhand()+"><br/> ");
            out.println("<b>Danger Level: </b> <input type=\"text\" name=\"dangerlevel\" value="+bean.getDangerlevel()+"><br/> ");
