...
//
         ...
         out.println(" <form method=\"post\" action=\"productList?opn=add\"  onSubmit=\"return validate(this);\">");
         out.println("<b>Category ID : </b> <input type=\"text\" name=\"categoryid\" /> <br/>");
         out.println("<b>Product Name: </b> <input type=\"text\" name=\"productname\" /> <br/>");
         out.println("<b>Product Price: </b> <input type=\"text\" name=\"productprice\" /> <br/>");
         out.println("<b>StockinHand: </b> <input type=\"text\" name=\"stockinhand\" /> <br/>");
         out.println("<b>DangerLevel: </b> <input type=\"text\" name=\"dangerlevel\" /> <br/>");
