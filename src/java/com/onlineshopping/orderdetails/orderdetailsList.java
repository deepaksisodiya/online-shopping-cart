...
public class orderdetailsList extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if ((odid != null) && (oid != null) && (productid != null) && (quantity != null)) {
            bean.setOdid(Integer.parseInt(odid));
            bean.setOid(Integer.parseInt(oid));
        ...
        try {
            ...
            response.sendRedirect("orderdetailsView");
        } finally {
        }
    } 
