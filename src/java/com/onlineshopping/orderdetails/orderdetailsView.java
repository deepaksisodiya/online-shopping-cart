 ...
 * @author deepak
 */
public class orderdetailsView extends HttpServlet {
...
//
//         out.println("<!--content-->");
            out.println("<h1>OrderDetails</h1>");
            out.println("<table>");
            out.println("<tr><th>Category name</th><th> CategoryDetails</th></tr>");
            categoryDAO rd = new categoryDAO();
            ArrayList<categoryBean> list = rd.findAll();
            for (categoryBean bean : list) {
                out.println("<tr>");
                out.println("<td>" + bean.getCategoryname()+ "</td>");
                out.println("<td>" + bean.getCategorydetails() + "</td>");
                System.out.println(bean.getCategoryid());
                out.println("<td><a href=\"/categoryList?opn=update&categoryid=" + bean.getCategoryid() + "\">Edit</a></td>");
                out.println("<td><a href=\"/categoryList?opn=delete&categoryid=" + bean.getCategoryid() + "\">Delete</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
 //         out.println("<!--content-->");
