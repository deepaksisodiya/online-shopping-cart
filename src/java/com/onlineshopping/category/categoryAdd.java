...
//
         ...
         out.println("<h1>Add Category</h1>");
         out.println(" <form method=\"post\" action=\"categoryList?opn=add\"  onSubmit=\"return validate(this);\">");
         out.println("<h3>Category Name : </h3><input type=\"text\" name=\"categoryname\" /> <br/>");
         out.println("<h3>Category Details : </h3></td><td> <input type=\"text\" name=\"categorydetails\" /> <br><br>");
