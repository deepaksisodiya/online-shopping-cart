...
//
         out.println("<!--content-->");
            ...
            out.println("<form method=\"post\" action=\"categoryList?opn=update\" onSubmit=\"return validate(this);\">");
            int id = Integer.parseInt(request.getParameter("categoryid"));
            categoryDAO cd = new categoryDAO();
            categoryBean bean = cd.find(id);
            out.println("<input type=\"hidden\" name=\"categoryid\" value="+bean.getCategoryid()+">");
            out.println("<b>Category Name : </b> <input type=\"text\" name=\"categoryname\" value="+bean.getCategoryname()+"> <br/>");
            out.println("<b>Category Details  : </b> <input type=\"text\" name=\"categorydetails\" value="+bean.getCategorydetails()+"><br/> ");
